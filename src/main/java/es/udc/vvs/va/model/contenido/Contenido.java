...
public interface Contenido {
   ...
   * lista de reproduccion presente, en el caso de las canciones o anuncios se
   * devuelve a si mismo como unico elemento de la lista.
   * 
  ...
  /**
   * Devuelve una lista de los contenidos que tienen la subcadena en su titulo,
   * en emisoras busca dentro de la lista de reproduccion, en canciones y
   * anuncios busca en el propio titulo.
   * 
  ...
  /**
   * Agrega un contenido a la emisora, este se agrega en la posicion siguiente a
   * la de la primera ocurrencia del predecesor. Si no existe el predecesor, se
   * agrega al final. No hace nada en el caso de canciones y anuncios.
   *
  ...
  /**
   * Elimina la primera ocurrencia del contenido en la emisora si existe. No
   * hace nada en el caso de canciones y anuncios.
   * 
   * @param contenido
