...
public class ServidorTransitivoTest {
  ...
  public void buscarEnServidorConCanciones() throws ContentManagerException {
    List<ServidorTransitivo> servidores = new ArrayList<ServidorTransitivo>();
    Boolean rand;
    String token;
    ...
    for (int i = 0; i < 10; i++) {
      for (List<Cancion> lC : Iterables.toIterable(new CancionListGenerator())) {
        ...
        ServidorTransitivo st = new ServidorTransitivo(lC.toString(), sp);
  ...
  public void testBusquedaTransitiva() throws ContentManagerException {
    ...
    ServidorTransitivo servidorTransitivo = new ServidorTransitivo(
    ...
    List<Contenido> contenidosEncontrados = (List<Contenido>) servidorTransitivo
        .buscar("Read", tokenTransitivo);
  ...
  public void testDarDeBajaTokenInexistente() throws ContentManagerException {
  ...
  @Test(expected = ContentManagerException.class)
  public void tesBajaServidorRelacionado() throws ContentManagerException {

    Servidor sp = new ServidorPlano("Servidor plano test");
    Servidor sr = new ServidorTransitivo("Servidor transitivo test", token, sp);
